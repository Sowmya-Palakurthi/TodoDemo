...
set CLASSPATH=%APP_HOME%\lib\ktor-demo-all.jar

@rem Execute ktor-demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KTOR_DEMO_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%KTOR_DEMO_EXIT_CONSOLE%" exit 1
exit /b 1
